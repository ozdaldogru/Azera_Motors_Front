...
function Footer() {
    return (
      <footer className="mb-0 bg-[#ccc]">
      <div className="flex flex-row justify-around mx-auto py-16 ">

            <div className=" flex flex-col  ml-5">

              <h2 className="text-[24px] text-bold underline underline-offset-4">Operation Hours:</h2>
              <ul className=" text-[20px] flex flex-col justify-left px-02">
            ...
            <ul className=" text-[20px] flex flex-wrap justify-center px-20 gap-6 md:gap-8 lg:gap-12">
            
              <li>
                <a className="text-green-900-bold transition hover:text-red-700" href="#"> About </a>
              </li>
        
              <li>
                <a className="text-green-900-bold transition hover:text-red-700" href="#"> Careers </a>
              </li>
        
              <li>
                <a className="text-green-900-bold transition hover:text-red-700" href="#"> History </a>
              </li>
        
              <li>
                <a className="text-green-900-bold transition hover:text-red-700" href="#"> Services </a>
              </li>
            ...
            <p className="mb-6 flex justify-center gap-6 md:gap-8">All Rights Reserved  &copy; Azera Motors</p>

            </div>
            <div className=" flex flex-col ml-5 border rounded-lg">
              <GoogleMaps />
            </div>
