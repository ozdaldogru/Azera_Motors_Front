...
<button
  onClick={handlePrev}
  className="absolute left-4 top-1/2 -translate-y-1/2 bg-opacity-100 rounded-full p-3 shadow-lg hover:bg-white hover:text-black transition-colors duration-200 z-10 flex items-center justify-center"
...
<button
  onClick={handleNext}
  className="absolute right-4 top-1/2 -translate-y-1/2 bg-opacity-100 rounded-full p-3 hover:bg-white hover:text-black transition-colors duration-200 z-10 flex items-center justify-center"
