  ...
  return (
    <div className="flex flex-col border-t">
      ...
      <div className="flex flex-row justify-between text-center gap-2 w-full py-2 max-[564px]:items-center max-[564px]:flex-col">
        {productInfo.history && productInfo.history.length > 0 ? (
         <Image onClick={handleOpenPdfModal} src="/carfax.svg" alt="carfax car history logo" width={115} height={50} style={{ height: "auto" }}/>
      ...
      <PdfModal pdfUrl={productInfo.history} isOpen={isPdfModalOpen} onClose={handleClosePdfModal} />
    </div>
  );
};
