...
const Navbar = () => {
  ...
  return (
    <div className='bg-[#d4dce2] w-full top-0 flex flex-wrap flex-row justify-between items-center p-4 max-[600px]:flex-row'>
                 <div className="flex gap-4 items-stretch sm:h-min-[88px] ">
                    <Link href="/">
                      <Image src="/logo.webp" alt="logo" width={300} height={300} style={{ height: "auto", width: "auto" }} className="max-[600px]:w-[250px]" loading="eager"/>
                    </Link>
                 </div>
